...
export function ProductCard({ product }: { product: Product }) {
  ...
  return (
    <article className="surface group flex flex-col p-5 transition duration-200 hover:border-accent/40 hover:shadow-[0_1px_0_rgb(var(--accent)/.25),0_12px_28px_-18px_rgb(var(--ink)/.35)]">
